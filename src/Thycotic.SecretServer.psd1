...
@{
    ...
    FunctionsToExport    = 'Add-TssFolderPermission', 'Add-TssGroupMember',
    'Add-TssSecretPermission', 'Add-TssSecretTemplateField',
    'Close-TssSecret', 'Disable-TssEventPipeline',
    'Disable-TssSecretCheckout', 'Disable-TssSecretEmail',
    'Disable-TssUnlimitedAdmin', 'Disable-TssUser',
    'Enable-TssEventPipeline', 'Enable-TssSecretCheckout',
    'Enable-TssSecretEmail', 'Enable-TssUnlimitedAdmin', 'Enable-TssUser',
    'Export-TssReport', 'Find-TssFolder', 'Find-TssGroup', 'Find-TssReport',
    'Find-TssSecret', 'Find-TssUser', 'Get-TssConfiguration',
    ...
    'Get-TssGroupRole', 'Get-TssGroupUser', 'Get-TssReport',
    'Get-TssReportCategory', 'Get-TssReportParameter',
    ...
    'New-TssSession', 'New-TssUser', 'Open-TssSecret', 'Remove-TssFolder',
