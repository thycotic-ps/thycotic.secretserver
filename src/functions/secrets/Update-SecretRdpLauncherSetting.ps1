function Update-SecretRdpLauncherSetting {
    <#
    .SYNOPSIS
    ...
    .LINK
    https://github.com/thycotic-ps/thycotic.secretserver/blob/main/src/functions/secrets/Update-SecretRdpLauncherSetting.ps1
