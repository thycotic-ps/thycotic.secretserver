function Set-SecretRpcPrivileged {
    <#
    .SYNOPSIS
    ...
    .LINK
    https://thycotic-ps.github.io/thycotic.secretserver/commands/Set-TssSecretRpcPrivilegedAccount

    .LINK
    https://github.com/thycotic-ps/thycotic.secretserver/blob/main/src/functions/<folder>/Set-SecretRpcPrivilegedAccount.ps1
